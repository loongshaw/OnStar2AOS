...
public class SysCharsetUtils {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		System.out.println("系统编码为："+getSystemFileCharset());
		System.out.println("系统为："+ System.getProperty("os.name"));
		
		SysCharsetUtils test = new SysCharsetUtils();
